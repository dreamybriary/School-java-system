...
public class enrollmentDashboard extends JFrame {
    ...
    private void checkOrCreateUser() {
        ...
        if (userId == -1) {
            // User does not exist, create with a default username and password
            String defaultUsername = userEmail.split("@")[0];
            String defaultPassword = "1234"; // default password
    ...
    private void initialize() {
        ...
        Image img = originalIcon.getImage().getScaledInstance(800, 599, Image.SCALE_SMOOTH);
        ...
        tableModel = new DefaultTableModel(
            new Object[]{"Application ID", "Name", "Course", "Year Level", "Date Submitted"}, 
            0
        );
                                                                                ...
                                                                                lblBackground.add(btnView);
                                                                                        ...
                                                                                        lblBackground.add(btnReview);
                                                                                                ...
                                                                                                table.setFillsViewportHeight(true);
                                                                                                        ...
                                                                                                        lblNewLabel.setIcon(new ImageIcon("C:\\Users\\PersonalPC\\Downloads\\597860802_1245052237492691_1592846045489078280_n.png"));
    ...
    private void openSubmitForm() {
        ...
        btnSubmitForm.addActionListener(e -> {
            ...
            int courseId = Queries.getCourseId(course);
            if (courseId == -1) {
    ...
    private void reviewApplication() {
        ...
        if (row >= 0) {
            String newStatus = JOptionPane.showInputDialog(
                this,
                "Enter new status (optional for future use):",
                "Submitted"
            );
